...
```{r}
colors <- c("Dolgopolov" = "darkblue", "del Potro" = "red", "Cilic" = "orange")
p <- ggplot() + 
  geom_path(data = the_dog_wins, mapping = aes(x = tny_date, y = games_won, color = "Dolgopolov")) + 
  geom_path(data = delpo_wins, mapping = aes(x = tny_date, y = games_won2, color = "del Potro")) + 
  geom_path(data = cilic_wins, mapping = aes(x = tny_date, y = games_won3, color = "Cilic")) + 
  labs(title = "Number of Games Necessary for Three 33 y/o Players to Win a Match",
